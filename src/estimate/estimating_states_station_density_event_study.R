estimating_states_station_density_event_study <- function(
    price_data = NA,
    german_stations = NA,
    microm_data_cleaned = NA
) {
    #' @title Estimating States Station Density Effects in Event Study Design
    #' 
    #' @description This function estimates the effects of station density on
    ...
    for (state in state_ids) {
        ...
        result <- estimating_station_density_event_study(
